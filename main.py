...
if __name__ == '__main__':
    ...
    parser.add_argument('--k', default=5, type=int, help='Top k most similar images used to predict the label')
    ...
    for epoch in range(1, epochs + 1):
        train_loss = train(model, train_loader, optimizer, temperature,  tau_plus,)
